  ...
  current_hospitalizations %>% 
    reactable::reactable(
      ...
      columns = list(
        ...
        change = reactable::colDef(name = "Change Since Yesterday", html = TRUE),
        hospital_beds = reactable::colDef(
          name = "Available Hospital Beds",
          html = TRUE
        ),
        icu_beds = reactable::colDef(
